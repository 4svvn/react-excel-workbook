  ...
  _createClass(Workbook, [{
    ...
    value: function download() {
      ...
      _react2.default.Children.forEach(this.props.children, function (sheet) {
        var columnWidth = _react2.default.Children.map(sheet.props.children, function (column) {
          var width = column.props.width ? column.props.width : '20';
          return { 'wch': width };
        });
        wb.Sheets[sheet.props.name] = sheet_from_array_of_arrays(_this4.createSheetData(sheet), columnWidth);
      });
